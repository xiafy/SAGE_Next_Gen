...
> 版本: v1.8
> 日期: 2026-03-02
> 状态: 🟢 F01-F13 对齐；v1.7 两阶段识别架构；v1.8 用户场景重定义（DEC-043）
> 上游文档: `docs/vision.md`
...
- AC9: MealPlanCard 支持逐道替换和「整套加入订单」
...
- AC7: 「咨询 AI」携带已选菜品列表进入 Chat，AI 首条回复针对已选菜品给出建议（DEC-043）
