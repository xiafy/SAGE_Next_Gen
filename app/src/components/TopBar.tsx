...
export function TopBar({ title, onBack, rightAction }: TopBarProps) {
  return (
    <div data-testid="sage-topbar" className="flex items-center justify-between px-4 py-3 border-b-2 border-[var(--color-sage-border)] bg-white">
      <div className="w-10">
        {onBack && (
          <button
            onClick={onBack}
            ...
            aria-label="Go back"
            data-testid="sage-topbar-back-btn"
          >
